  ...
  return (
    <aside className="app-sidebar">
      ...
      <div style={{ padding: '18px 16px 14px', borderBottom: '1px solid var(--color-border)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 11.5, color: 'var(--color-steel)', marginTop: 1 }}>
      ...
      <nav style={{ flex: 1, padding: '6px 0 8px', overflowY: 'auto' }}>
        <div style={{ padding: '8px 16px 4px', fontSize: 11, fontWeight: 600, color: 'var(--color-placeholder)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
          导航
        </div>
        <NavLink
      ...
      <div style={{ padding: '10px 12px 12px', borderTop: '1px solid var(--color-border)' }}>
        <div style={{
          ...
          <div style={{ minWidth: 0, flex: 1 }}>
            ...
            <div style={{ fontSize: 11, color: 'var(--color-steel)', marginTop: 1 }}>
