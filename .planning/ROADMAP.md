...
**Plans**: 4 plans
- [ ] 30-01-PLAN.md — FeishuSyncLog 模型扩展 + Alembic 迁移（leading_zero_fallback_count 字段）
- [ ] 30-02-PLAN.md — ImportService 改造：Excel 模板文本格式 + 读入端 sanity check
- [ ] 30-03-PLAN.md — FeishuService 改造：_map_fields 去 int 误用 + validate_field_mapping + 容忍匹配计数器
- [ ] 30-04-PLAN.md — API + 前端：422 错误映射 + FeishuConfig 错误展示 + SyncStatusCard 黄色提示
...
| 30. 工号前导零修复 | v1.4 | 0/4 | In progress | — |
